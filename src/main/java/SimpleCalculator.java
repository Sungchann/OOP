...
public class SimpleCalculator extends javax.swing.JFrame {
    ...
    private void divisionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_divisionActionPerformed
        ...
        if (checkInputValidity() == 1){
            try{
                int varOne = Integer.parseInt(firstInteger.getText());
                int varTwo = Integer.parseInt(secondInteger.getText());
                int resultSample = varOne/varTwo;
                result.setText(String.valueOf(Float.parseFloat(firstInteger.getText())/ Float.parseFloat(secondInteger.getText())));
            }
    ...
    private int checkInputValidity(){
        try{
            float varOne, varTwo;
            varOne = Float.parseFloat(firstInteger.getText());
            varTwo = Float.parseFloat(secondInteger.getText());
            return 1;
